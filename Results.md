...
From the above chart, we observe that the subjects found the application easy in general. In addition to this, 60% of the subjects reported it as  extremely simple to understand. This is expected because using the application requires just a few clicks and subjects had enough knowledge to use GitHub. Thus, the subjects may have found it easy to work with.
